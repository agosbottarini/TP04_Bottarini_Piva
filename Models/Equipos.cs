...
{
    public static List<string> ListaEquipos {get; private set;} = new List<string>(){"1. River || ", "2. Boca || ", "3. Huracan || ", "4. Ferro || ", "San Lorenzo", "Racing", "Estudiantes de La Plata", "Independiente", "Belgrano", "Talleres"};
