...
{
    public static List<string> ListaEquipos {get; private set;} = new List<string>(){"1. River || ", "2. Boca || ", "3. Huracan || ", "4. Ferro || ", "5. San Lorenzo  || ", "6.  Racing || ", "7. Estudiantes de La Plata || ", "8. Independiente || ", "9. Belgrano || ", "10. Talleres"};
